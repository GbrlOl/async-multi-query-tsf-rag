...
class HybridRAG:
    ...
    def _hybrid_retriver(self):
        """Acá orquesto la recuperación híbrida"""
        self.embedd_bm25_retriever = EmbeddingBM25Retriever(
            self.embeddings_retriever, self.bm25_retriever
        )
    ...
    def _setup_query_engine(self):
        ...
        self.query_engine = RetrieverQueryEngine.from_args(
            self.embedd_bm25_retriever, text_qa_template=qa_template
        )
