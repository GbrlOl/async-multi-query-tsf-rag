...
from utils import EmbeddingBM25RerankRetriever
...
class AdvancedHybridRAG:
    ...
    def __init__(
        ...
        path_bm25: str,  # Nota, debo establecer acá los parámetros que no llevan valor por defectos, no puede ser después
        ...
        self.embeddings_retriever = None
        self.bm25_retriever = None
        # self.embedd_bm25_retriever = None
        self.cross_encoder = None
        self.query_engine = None
        self.embedd_bm25_cross_retriever = None

        # Configurar el sistema - NOTA: El orden de esto sí importa ATENTO!!!!!!
        self._setup_embeddings()
        self._setup_cross_encoder()
        self._setup_llm()
        self._load_vector_storage()
        self._setup_embeddings_retriever()
        self._setup_bm25()
        self._embeddings_bm25_cross_retriever()
    ...
    def _setup_bm25(self):
        ...
        self.bm25_retriever = BM25Retriever.from_persist_dir(self.path_bm25)

    def _setup_embeddings_retriever(self):
        self.embeddings_retriever = self.vector_index.as_retriever(
    ...
    # Acá está el orquestador retrieval que contiene Embeddings, BM25 y CrossEncoder
    def _embeddings_bm25_cross_retriever(self):
        """Acá orquesto la recuperación híbrida"""
        self.embedd_bm25_cross_retriever = EmbeddingBM25RerankRetriever(
            self.embeddings_retriever, self.bm25_retriever, reranker=self.cross_encoder
        )
    ...
    def _setup_query_engine(self):
        ...
        #     similarity_top_k=self.top_k,
        #     # node_postprocessors=[self.cross_encoder],
        # )
        self.query_engine = RetrieverQueryEngine.from_args(
            self.embedd_bm25_cross_retriever, text_qa_template=qa_template
        )
